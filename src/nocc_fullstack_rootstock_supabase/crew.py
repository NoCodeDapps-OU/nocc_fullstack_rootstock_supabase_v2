...
class FrontendCrews:
    ...
    def web3js_integration_crew(self, frontend_code):
        integrator = self.agents.web3js_integrator()
        integration_task = FrontendTasks.integrate_web3js(integrator, frontend_code)
        return Crew(
            agents=[integrator],
