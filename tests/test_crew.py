...
from nocc_fullstack_rootstock_supabase.crew import NoccFullstackRootstockSupabaseCrew

class TestNoccFullstackRootstockSupabaseCrew(unittest.TestCase):
    def setUp(self):
        self.crew = NoccFullstackRootstockSupabaseCrew()
